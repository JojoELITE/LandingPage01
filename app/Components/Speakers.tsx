                    ...
                    <div className="bg-[#1D1E25] p-6">
                        ...
                        <div className="flex flex-wrap gap-20 justify-center mt-8">
                            <div className="flex flex-col text-center">
                                ...
                                <div className="flex w-20 justify-center bg-gray-400 rounded-full px-2 py-1 gap-2 mb-4 relative mt-16 ml-2">
                                    <Facebook />
                                    <Instagram />
                                    <Twitter />
                                    <Linkedin />
                                ...
                                <div className=''>
                                    <p className="text-xs font-semibold ">Cheline Agustine</p>
                            ...
                            <div className="flex flex-col text-center">
                                ...
                                <div className="flex w-20 items-center justify-center bg-gray-400 rounded-full px-2 py-1 gap-2 mb-4 relative mt-16 ml-2">
                                    <Facebook />
                                    <Instagram />
                                    <Twitter />
                                    <Linkedin />
